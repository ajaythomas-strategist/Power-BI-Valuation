"""
Generates realistic sample PBIP test fixtures:
- Sample Question Paper
- Sample Answer Key
- 5 Student Submissions:
  - 23001: Perfect implementation (100% - uses Date Hierarchy variation)
  - 23002: Partial implementation (75% - measure correct, non-permitted axis variation)
  - 23003: Low score (25% - wrong visual type, incorrect DAX formula)
  - 23004: Missing submission (empty folder exception)
  - 23005: Invalid submission (non-PBIP corrupted files exception)
"""
import io
import json
import zipfile
...
def create_sample_dataset_archive() -> bytes:
    ...
    with zipfile.ZipFile(buf, "w", zipfile.ZIP_DEFLATED) as z:
        ...
        # -------------------------------------------------------------
        # 2. Student 23002 (75% - Q1, Q2, Q3 correct; Q4 missing bar chart)
        # -------------------------------------------------------------
        ...
        # -------------------------------------------------------------
        # 3. Student 23003 (25% - Q1 wrong visual type, Q2 correct, Q3 wrong DAX, Q4 missing)
        # -------------------------------------------------------------
        ...
        # -------------------------------------------------------------
        # 4. Student 23004 (Exception: Empty folder / missing PBIP)
        # -------------------------------------------------------------
